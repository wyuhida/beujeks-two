...
$router->group(['middleware' => 'auth:provider'], function($app) {
    ...
    $app->post('/update/status', 'V1\Common\Provider\HomeController@updatestatus');
    ...
    $app->get('/services_status/{id}', 'V1\Common\Provider\HomeController@services_status');
     $app->get('/serviceride_status/{id}', 'V1\Common\Provider\HomeController@servicesRide_status');
