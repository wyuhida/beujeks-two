...
$router->group(['middleware' => 'auth:admin'], function ($app) {
    ...
    $app->group(['prefix'=>'service'], function($app){
        ...
        $app->get('/categories/{id}/updateStatus', ['middleware' => 'demo', 'uses' =>'V1\Service\Admin\ServiceCategoryController@updateStatus']);
        ...
        $app->get('/subcategories/{id}/updateStatus', ['middleware' => 'demo', 'uses' =>'V1\Service\Admin\ServiceSubCategoryController@updateStatus']);
