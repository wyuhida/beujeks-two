...
$app->get('/storetypes/{id}/updateStatus', ['middleware' => 'demo', 'uses' => 'V1\Order\Admin\Resource\StoretypeController@updateStatus']);
...
$app->get('/cuisines/{id}/updateStatus', ['middleware' => 'demo', 'uses' => 'V1\Order\Admin\Resource\CuisinesController@updateStatus']);
...
$app->get('/shops/{id}/updateStatus', ['middleware' => 'demo', 'uses' => 'V1\Order\Admin\Resource\ShopsController@updateStatus']);
...
$app->get('/addon/{id}/updateStatus', ['middleware' => 'demo', 'uses' => 'V1\Order\Admin\Resource\ShopsaddonController@updateStatus']);
...
$app->get('/category/{id}/updateStatus', ['middleware' => 'demo', 'uses' => 'V1\Order\Admin\Resource\ShopscategoryController@updateStatus']);
...
$app->get('/items/{id}/updateStatus', ['middleware' => 'demo', 'uses' => 'V1\Order\Admin\Resource\ShopsitemsController@updateStatus']);
//request history
