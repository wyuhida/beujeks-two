...
class StoreType extends BaseModel
{
    ...
    return $this->hasOne('App\Models\Common\ProviderService','category_id','id')->where('admin_service','ORDER')->where('provider_id',Auth::guard('provider')->user()->id)->with(['providervehicle'=>function($q){
