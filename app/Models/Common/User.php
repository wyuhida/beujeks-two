...
class User extends BaseModel implements JWTSubject, AuthenticatableContract, AuthorizableContract
{
     ...
     */
    protected $hidden = [
     'password', 'remember_token', 'jwt_token', 'device_id', 'social_unique_id', 'stripe_cust_id', 'otp', 'qrcode_url', 'referal_count', 'created_type', 'created_by', 'modified_type', 'modified_by', 'deleted_type', 'deleted_by','updated_at',
    ];
