...
class TripController extends Controller
{
    ...
    public function index(Request $request)
	{
		try{
			...
			$IncomingRequests = RideRequest::with(['user', 'payment', 'chat', 'ride','rental_package'])
	...
	public function accept_ride(Request $request)
	{
		...
		$newRequest = RideRequest::with('rental_package')->where('otp', $request->otp)->first();
	...
	public function trips(Request $request)
	{
		try{
		    ...
		    $ProviderRequests = RideRequest::select('id', 'booking_id', 'assigned_at', 's_address', 'd_address','provider_id','user_id','timezone','ride_delivery_id', 'status', 'provider_vehicle_id','started_at','service_type');
		    $data=(new ProviderServices())->providerHistory($request,$ProviderRequests,$withCallback);
		   			  
			$jsonResponse['total_records'] = count(array($data));
